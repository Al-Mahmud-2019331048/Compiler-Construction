...
#line 1130 "y.tab.c"
  ...
  case 4: /* expression: expression PLUS NUMBER  */
#line 17 "calculate.y"
                                     { yyval = yyvsp[-2] + yyvsp[0]; }
#line 1136 "y.tab.c"
    break;

  case 5: /* expression: expression MINUS NUMBER  */
#line 18 "calculate.y"
                                    { yyval = yyvsp[-2] - yyvsp[0]; }
#line 1142 "y.tab.c"
    break;

  case 6: /* expression: expression MUL NUMBER  */
#line 19 "calculate.y"
                                  {yyval = yyvsp[-2] * yyvsp[0]; }
#line 1148 "y.tab.c"
    break;

  case 7: /* expression: expression DIV NUMBER  */
#line 20 "calculate.y"
                                  {yyval = yyvsp[-2] / yyvsp[0]; }
#line 1154 "y.tab.c"
    break;
