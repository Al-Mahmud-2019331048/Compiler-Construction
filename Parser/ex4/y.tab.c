...
#line 35 "parser.y"
                  { 
                     add_transition(state, 'ε', yyvsp[-2]); 
                     add_transition(state, 'ε', yyvsp[0]); 
                     yyval = state++; 
                  }
#line 1138 "y.tab.c"
    break;
...
#line 40 "parser.y"
                  { 
                     add_transition(yyvsp[-1], 'ε', yyvsp[0]); 
                     yyval = yyvsp[-1]; 
                  }
#line 1147 "y.tab.c"
    break;
...
#line 45 "parser.y"
                  { 
                     add_transition(state, 'ε', yyvsp[-1]); 
                     add_transition(yyvsp[-1], 'ε', state); 
                     yyval = state++; 
                  }
#line 1163 "y.tab.c"
    break;
...
#line 50 "parser.y"
                  { 
                     add_transition(state, yyvsp[0], state + 1); 
                     yyval = state; 
                     state += 2;
                  }
#line 1173 "y.tab.c"
